...
void VideoMainTrial::init_conn()
{
    ...
    connect (ui->video_ribbon, &VideoTrialRibbon::file_new, this, &VideoMainTrial::create_analysis);
    ...
    connect (ui->video_ribbon, &VideoTrialRibbon::file_save, this, &VideoMainTrial::on_save);
    connect (ui->video_ribbon, &VideoTrialRibbon::file_saveas, this, &VideoMainTrial::on_save_as);
    connect (ui->video_ribbon, &VideoTrialRibbon::file_open, this, &VideoMainTrial::on_open);
    connect (ui->video_ribbon, &VideoTrialRibbon::file_exit, this, &VideoMainTrial::close);
