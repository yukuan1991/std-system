#include "most_data_widget.h"
#include "ui_most_data_widget.h"
#include <QScrollBar>
#include <QMessageBox>

most_data_widget::most_data_widget(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::most_data_widget)
{
    ui->setupUi(this);
...
most_data_widget::~most_data_widget()
{
    delete ui;
}

QString most_data_widget::get_std_time_sum() const
{
    auto col = 5;
    double sum = 0;
...
void most_data_widget::add_code(const QVariant &code)
{
...
void most_data_widget::set_unit(double unit)
{
    this->result_model_->setData (QModelIndex (), unit, Qt::UserRole + 100);
}

void most_data_widget::next_code()
{
...
json most_data_widget::save_result() try
{
...
bool most_data_widget::load_result(const json &result) try
{
    QModelIndex index;
...
void most_data_widget::set_row(int num)
{
...
bool most_data_widget::task_content_check()
{
...
void most_data_widget::on_paste()
{
    if (view_ != nullptr)
    {
        view_->on_paste ();
...
void most_data_widget::set_view()
{
